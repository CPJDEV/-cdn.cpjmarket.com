/**
 * Created by douglasmalcolm on 10/14/14.
 */
(function(window, undefined) {
    ...
    S.paths.widgets = S.widgets || S.protocol + ((S.protocol == 'https://')? 's3.amazonaws.com/' : '') + 'static.searchanise.com/widgets.39187.min.js';
